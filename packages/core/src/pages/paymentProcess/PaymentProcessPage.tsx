                  ...
                  <div className='flex items-center ms-4'>
                    ...
                    <Tooltip delay={0} closeDelay={0}>
                      ...
                      <Tooltip.Content placement='bottom' showArrow className='max-w-72'>
                        <Tooltip.Arrow />
                        <p className='text-sm wrap-break-word [word-break:normal]'>{EMAIL_HINT}</p>
                      </Tooltip.Content>
                    </Tooltip>
                  </div>
                </TextField>
              ...
              <div className='flex flex-col gap-6'>
                ...
                <div className='rounded-2xl bg-foreground/[0.04] p-4 sm:p-5'>
                  ...
                  <p className='pt-4 text-sm leading-relaxed text-muted'>
                    ...
                    . If the subscription includes auto-renewal, automatic charges will occur at the
                    standard price. The promo code can only be applied to the first subscription
                    payment. The subscription owner can manage or cancel it at any time through the{' '}
            ...
            <Block className='p-5 sm:p-6'>
              <div className='flex flex-col gap-5'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  {plan.discountPercent > 0 && (
                    <Chip size='sm' className={`w-fit border-none text-[white] ${BRAND_GRADIENT}`}>
