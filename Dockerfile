...
ENV VITE_REMNAWAVE_URL=$VITE_REMNAWAVE_URL \
    ...
    VITE_STARS_AMOUNT=$VITE_STARS_AMOUNT \
    ...
    VITE_EXTRA_DEVICE_STICKER_FILE_ID=$VITE_EXTRA_DEVICE_STICKER_FILE_ID \
